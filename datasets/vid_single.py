...
class CocoDetection(TvCocoDetection):
    ...
    def __getitem__(self, idx):
        ...
        # img_info_ignore = self.coco_ignores.loadImgs([img_id])[0]
        # img_name_ignore = img_info_ignore['file_name']
        # print(img_info_ignore)
        ...
        # print(f"Annotations ignore for Image ID {img_id}:")
        # print(anns_ignore)
...
def build(image_set, args):
    ...
    #     dataset = CocoDetection(img_folder, ann_file, transforms=make_coco_transforms(image_set, args.img_side), is_train=is_train, return_masks=args.masks, cache_mode=args.cache_mode, local_rank=get_local_rank(), local_size=get_local_size())
    #     datasets.append(dataset)
    # if len(datasets) == 1:
    #     return datasets[0]
    # return ConcatDataset(datasets)
